...
$ciudad = $data['moca_orientacion']['ciudad'];
...
if ($stmt_check->num_rows > 0) {
    ...
    $sql_update = "UPDATE consentimiento_f SET moca_orientacion_fecha = ?, moca_orientacion_ciudad = ?, moca_orientacion_lugar = ?, fecha_fin = ? WHERE correo = ?";
    $stmt_update = $conn->prepare($sql_update);
    $stmt_update->bind_param("sssss", $date, $ciudad, $place, $fecha_fin, $email);
