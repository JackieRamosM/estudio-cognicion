...
if (isset($data['updateFlag']) && $data['updateFlag'] === true) {
    ...
    $sql_update = "UPDATE consentimiento_f SET moca_identificacion_flag = 1 WHERE correo = ?";
    ...
    $sql_check = "SELECT moca_identificacion_flag FROM consentimiento_f WHERE correo = ?";
